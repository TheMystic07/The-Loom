...
export function ParticipantView({ participantId }) {
  console.log("ppppp \\\\\\\\ ---- "+typeof(participantId));
//   const dope=[];
//   const uo=[]
//   const fil=[]
//   dope.push(participantId);
...
//   }
  ...
  return mode === "CONFERENCE" ? (
    <div
      ...
      className={`h-full w-full  bg-red-700 relative overflow-hidden rounded-lg video-cover`}
    >
      <audio ref={micRef} autoPlay muted={isLocal} />{console.log("IDDDDD-------- "+participantId)}
      {webcamOn ? (
        <ReactPlayer
          //
